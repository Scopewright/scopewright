...
- `rdmSearchEnriched` fieldCatMap : `materiau` → `['PLACAGE', 'PANNEAU', 'PANNEAU MÉLAMINE', 'PANNEAU BOIS', 'PANNEAUX', 'MATÉRIAU', 'MATERIAU']`, `bande_chant` → `['BANDE DE CHANT', 'BANDES DE CHANT']`, `finition` → `['FINITION', 'FINITION BOIS', 'FINITIONS']`, `bois_brut` → `['BOIS BRUT']` (jamais `'BOIS'` seul — trop permissif, capture PANNEAU BOIS et FINITION BOIS)
