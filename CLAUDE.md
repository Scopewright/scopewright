...
8. **Sanitisation messages** : `callAiAssistant()` filtre les messages avec `content` vide/null/`[]` avant envoi à l'API (prévient erreur Anthropic 400 "non-empty content")
