...
4. Pour chaque regle :
   ...
   - **Apres `$default:`** : propage l'ID (`_defaultResolvedId`) et le `client_text` resolu dans `materialCtx` (3 points de sortie : cache hit, candidat unique, modale technique). Marque `materialCtx._updatedBySiblingDefault = true`
